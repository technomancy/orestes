...
int layer1[44] = {
  MODIFIERKEY_SHIFT + KEY_1, MODIFIERKEY_SHIFT + KEY_2, KEY_UP, MODIFIERKEY_SHIFT + KEY_MINUS, MODIFIERKEY_SHIFT + KEY_EQUAL, KEY_0,
    KEY_PAGE_UP, KEY_7, KEY_8, KEY_9, MODIFIERKEY_SHIFT + KEY_8,
  MODIFIERKEY_SHIFT + KEY_3, KEY_LEFT, KEY_DOWN, KEY_RIGHT, MODIFIERKEY_SHIFT + KEY_4, KEY_0,
    KEY_PAGE_DOWN, KEY_4, KEY_5, KEY_6, MODIFIERKEY_SHIFT + KEY_RIGHT_BRACE,
  KEY_MINUS, KEY_EQUAL, MODIFIERKEY_SHIFT + KEY_9, MODIFIERKEY_SHIFT + KEY_0, MODIFIERKEY_SHIFT + KEY_7, MODIFIERKEY_ALT,
    KEY_TILDE, KEY_1, KEY_2, KEY_3, KEY_BACKSLASH,
  112, MODIFIERKEY_SHIFT + KEY_INSERT, MODIFIERKEY_GUI, MODIFIERKEY_SHIFT, KEY_BACKSPACE, MODIFIERKEY_CTRL,
    KEY_SPACE, 201, KEY_E, KEY_0, KEY_RIGHT_BRACE };

int layer2[44] = {
    KEY_HOME, KEY_UP, KEY_END, KEY_INSERT, KEY_PAGE_UP, KEY_0, KEY_UP, KEY_F7, KEY_F8, KEY_F9, KEY_F10,
    KEY_LEFT, KEY_DOWN, KEY_RIGHT, KEY_DELETE, KEY_PAGE_DOWN, KEY_0, KEY_DOWN, KEY_F4, KEY_F5, KEY_F6, KEY_F11,
    0, 0, 0, 0, 110, MODIFIERKEY_ALT, 0, KEY_F1, KEY_F2, KEY_F3, KEY_F12,
    0, 0, MODIFIERKEY_GUI, MODIFIERKEY_SHIFT, KEY_BACKSPACE, MODIFIERKEY_CTRL, KEY_SPACE, 201, 0, 0, 0 };
